                ...
                <form action="./collections.php" method="get">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_ACER" value="ACER" <?php if(checkTenHang("ACER")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_ASUS" value="ASUS" <?php if(checkTenHang("ASUS")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_DELL" value="DELL" <?php if(checkTenHang("DELL")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_GIGABYTE" value="GIGABYTE" <?php if(checkTenHang("GIGABYTE")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_HP" value="HP" <?php if(checkTenHang("HP")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_LG" value="LG" <?php if(checkTenHang("LG")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_LENOVO" value="LENOVO" <?php if(checkTenHang("LENOVO")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_MICROSOFT" value="MICROSOFT" <?php if(checkTenHang("MICROSOFT")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="tenHang[]" id="mobile_tenHang_MSI" value="MSI" <?php if(checkTenHang("MSI")) echo'checked' ?> >
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-6" style="height: 38px;">                        
                            ...
                            <input type="checkbox" name="mauSac[]" id="mobile_mauSac_trang" value="trắng" <?php if(checkMauSac("trắng")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">                        
                            ...
                            <input type="checkbox" name="mauSac[]" id="mobile_mauSac_bac" value="bạc" <?php if(checkMauSac("bạc")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">                        
                            ...
                            <input type="checkbox" name="mauSac[]" id="mobile_mauSac_xam" value="xám" <?php if(checkMauSac("xám")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">                        
                            ...
                            <input type="checkbox" name="mauSac[]" id="mobile_mauSac_den" value="đen" <?php if(checkMauSac("đen")) echo'checked' ?> >
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_i3" value="Core i3" <?php if(checkCPU("Core i3")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_i5" value="Core i5" <?php if(checkCPU("Core i5")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_i7" value="Core i7" <?php if(checkCPU("Core i7")) echo'checked' ?> >
                        </div>
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_i9" value="Core i9" <?php if(checkCPU("Core i9")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_r3" value="Ryzen 3" <?php if(checkCPU("Ryzen 3")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_r5" value="Ryzen 5" <?php if(checkCPU("Ryzen 5")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_r7" value="Ryzen 7" <?php if(checkCPU("Ryzen 7")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">
                            ...
                            <input type="checkbox" name="CPU[]" id="mobile_cpu_r9" value="Ryzen 9" <?php if(checkCPU("Ryzen 9")) echo'checked' ?> >
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-6" style="height: 38px;">                    
                            ...
                            <input type="checkbox" name="RAM[]" id="mobile_ram_4gb" value="4" <?php if(checkRAM("4")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">                    
                            ...
                            <input type="checkbox" name="RAM[]" id="mobile_ram_8gb" value="8" <?php if(checkRAM("8")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">                    
                            ...
                            <input type="checkbox" name="RAM[]" id="mobile_ram_16gb" value="16" <?php if(checkRAM("16")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">                    
                            ...
                            <input type="checkbox" name="RAM[]" id="mobile_ram_32gb" value="32" <?php if(checkRAM("32")) echo'checked' ?> >
                        </div>
                        ...
                        <div class="col-6" style="height: 38px;">                    
                            ...
                            <input type="checkbox" name="RAM[]" id="mobile_ram_64gb" value="64" <?php if(checkRAM("64")) echo'checked' ?> >
                        </div>
                    </div>
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 d-flex ps-0 align-items-center">
                            <input type="number" class="form-control d-inline-block" name="minPrice" min="0" placeholder="Từ" value="<?php echo $minPrice?>" style="width: 100px; ">
                            <p class="d-inline-block fw-bold mx-2" >~</p>
                            <input type="number" class="form-control d-inline-block" name="maxPrice" min="0" placeholder="Đến" value="<?php echo $maxPrice?>" style="width: 100px; " >
                        </div>
                    </div>
                    <button type="submit" class="btn btn-filter">Tìm kiếm</button>
                    <input type="hidden" name="tenSP" value="<?php echo $_GET['tenSP'] ?? "" ?>">
                </form>
            </div>
        </div>
            ...
            <form action="./collections.php" method="get">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-10 d-flex ps-0 align-items-center">
                        ...
                        <?php if(checkTenHang("ACER")) echo 'active'?>">ACER</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_ACER" value="ACER" <?php if(checkTenHang("ACER")) echo'checked' ?> >

                        <label for="tenHang_ASUS" onclick="chonHoacHuyChon('label_tenHang_ASUS')" id="label_tenHang_ASUS" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("ASUS")) echo 'active'?>">ASUS</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_ASUS" value="ASUS" <?php if(checkTenHang("ASUS")) echo'checked' ?> >

                        <label for="tenHang_DELL" onclick="chonHoacHuyChon('label_tenHang_DELL')" id="label_tenHang_DELL" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("DELL")) echo 'active'?>">DELL</label> 
                        <input type="checkbox" name="tenHang[]" id="tenHang_DELL" value="DELL" <?php if(checkTenHang("DELL")) echo'checked' ?> >
                        ...
                        <?php if(checkTenHang("GIGABYTE")) echo 'active'?>">GIGABYTE</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_GIGABYTE" value="GIGABYTE" <?php if(checkTenHang("GIGABYTE")) echo'checked' ?> >

                        <label for="tenHang_HP" onclick="chonHoacHuyChon('label_tenHang_HP')" id="label_tenHang_HP" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("HP")) echo 'active'?>">HP</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_HP" value="HP" <?php if(checkTenHang("HP")) echo'checked' ?> >

                        <label for="tenHang_LG" onclick="chonHoacHuyChon('label_tenHang_LG')" id="label_tenHang_LG" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("LG")) echo 'active'?>">LG</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_LG" value="LG" <?php if(checkTenHang("LG")) echo'checked' ?> >

                        <label for="tenHang_LENOVO" onclick="chonHoacHuyChon('label_tenHang_LENOVO')" id="label_tenHang_LENOVO" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("LENOVO")) echo 'active'?>">LENOVO</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_LENOVO" value="LENOVO" <?php if(checkTenHang("LENOVO")) echo'checked' ?> >
                        ...
                        <?php if(checkTenHang("MICROSOFT")) echo 'active'?>">MICROSOFT</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_MICROSOFT" value="MICROSOFT" <?php if(checkTenHang("MICROSOFT")) echo'checked' ?> > 

                        <label for="tenHang_MSI" onclick="chonHoacHuyChon('label_tenHang_MSI')" id="label_tenHang_MSI" class="me-1 btn btn-filter 
                        <?php if(checkTenHang("MSI")) echo 'active'?>">MSI</label>                        
                        <input type="checkbox" name="tenHang[]" id="tenHang_MSI" value="MSI" <?php if(checkTenHang("MSI")) echo'checked' ?> >
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-10 d-flex ps-0 align-items-center">
                        ...
                        <?php if(checkMauSac("trắng")) echo 'active'?>">Trắng</label>                        
                        <input type="checkbox" name="mauSac[]" id="mauSac_trang" value="trắng" <?php if(checkMauSac("trắng")) echo'checked' ?> >

                        <label for="mauSac_bac" onclick="chonHoacHuyChon('label_mauSac_bac')" id="label_mauSac_bac" class="me-1 btn btn-filter 
                        <?php if(checkMauSac("bạc")) echo 'active'?>">Bạc</label>                        
                        <input type="checkbox" name="mauSac[]" id="mauSac_bac" value="bạc" <?php if(checkMauSac("bạc")) echo'checked' ?> >

                        <label for="mauSac_den" onclick="chonHoacHuyChon('label_mauSac_xam')" id="label_mauSac_xam" class="me-1 btn btn-filter 
                        <?php if(checkMauSac("xám")) echo 'active'?>">Xám</label>                        
                        <input type="checkbox" name="mauSac[]" id="mauSac_xam" value="xám" <?php if(checkMauSac("xám")) echo'checked' ?> >
                    
                        <label for="mauSac_den" onclick="chonHoacHuyChon('label_mauSac_den')" id="label_mauSac_den" class="me-1 btn btn-filter 
                        <?php if(checkMauSac("đen")) echo 'active'?>">Đen</label>                        
                        <input type="checkbox" name="mauSac[]" id="mauSac_den" value="đen" <?php if(checkMauSac("đen")) echo'checked' ?> >
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-10 d-flex ps-0 align-items-center">
                        ...
                        <?php if(checkCPU("Core i3")) echo 'active'?>">Core i3</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_i3" value="Core i3" <?php if(checkCPU("Core i3")) echo'checked' ?> >
                        
                        <label for="cpu_i5" onclick="chonHoacHuyChon('label_cpu_i5')" id="label_cpu_i5" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Core i5")) echo 'active'?>">Core i5</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_i5" value="Core i5" <?php if(checkCPU("Core i5")) echo'checked' ?> >
                        
                        <label for="cpu_i7" onclick="chonHoacHuyChon('label_cpu_i7')" id="label_cpu_i7" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Core i7")) echo 'active'?>">Core i7</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_i7" value="Core i7" <?php if(checkCPU("Core i7")) echo'checked' ?> >
                        
                        <label for="cpu_i9" onclick="chonHoacHuyChon('label_cpu_i9')" id="label_cpu_i9" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Core i9")) echo 'active'?>">Core i9</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_i9" value="Core i9" <?php if(checkCPU("Core i9")) echo'checked' ?> >
                        
                        <label for="cpu_r3" onclick="chonHoacHuyChon('label_cpu_r3')" id="label_cpu_r3" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Ryzen 3")) echo 'active'?>">Ryzen 3</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_r3" value="Ryzen 3" <?php if(checkCPU("Ryzen 3")) echo'checked' ?> >
                        
                        <label for="cpu_r5" onclick="chonHoacHuyChon('label_cpu_r5')" id="label_cpu_r5" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Ryzen 5")) echo 'active'?>">Ryzen 5</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_r5" value="Ryzen 5" <?php if(checkCPU("Ryzen 5")) echo'checked' ?> >
                        
                        <label for="cpu_r7" onclick="chonHoacHuyChon('label_cpu_r7')" id="label_cpu_r7" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Ryzen 7")) echo 'active'?>">Ryzen 7</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_r7" value="Ryzen 7" <?php if(checkCPU("Ryzen 7")) echo'checked' ?> >
                        
                        <label for="cpu_r9" onclick="chonHoacHuyChon('label_cpu_r9')" id="label_cpu_r9" class="me-1 btn btn-filter 
                        <?php if(checkCPU("Ryzen 9")) echo 'active'?>">Ryzen 9</label>                        
                        <input type="checkbox" name="CPU[]" id="cpu_r9" value="Ryzen 9" <?php if(checkCPU("Ryzen 9")) echo'checked' ?> >
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="col offset-md-2">
                    <button type="submit" class="me-1 btn btn-filter">Tìm kiếm</button>
                </div>
                <input type="hidden" name="tenSP" value="<?php echo $_GET['tenSP'] ?? "" ?>">
            </form>
        </div>
