        ...
        <div class="col-8">
            <div class="row mb-3">
                <div class="container-fluid p-3 d-flex justify-content-center" style="background-color: var(--gray-color)">
                    <img src="./assets/image/product/item1.png" alt="item1" class="w-50">
                </div>
            </div>
            <div class="row">
                <div class="container-fluid p-3" style="background-color: var(--gray-color)">
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            ...
                            <div class="row">
                                <p>AMD Ryzen 5 5500U, 6 nhân, 12 luồng</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row">
                                <p>
                                AMD Radeon Graphíc, NVidia MX 450 </br>
                                2 x Type-C, 1 x USB-A </br>
                                1.15kg
                                </p>
                            </div>
                        </div>
